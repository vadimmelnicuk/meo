...
export const highlightStyle = HighlightStyle.define([
  ...
  { tag: [t.name, t.deleted, t.character], color: base05 },
  { tag: t.macroName, color: base06, fontStyle: 'italic' },
  { tag: t.variableName, color: base01 },
  { tag: t.propertyName, color: base09, fontStyle: 'normal' },
  { tag: t.typeName, color: base06 },
  { tag: t.className, color: base09 },
  { tag: t.namespace, color: base05 },
  { tag: t.operator, color: base01 },
  { tag: t.operatorKeyword, color: base04 },
  ...
  { tag: t.modifier, color: base04, fontStyle: 'italic' },
  { tag: t.self, color: base04, fontStyle: 'italic' },
